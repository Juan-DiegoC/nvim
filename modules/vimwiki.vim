...
let Relay_Wiki.auto_eArtificial_Intelligenceport = 1 " Will automatically create an HTML file when wiki is saved
let Relay_Wiki.auto_generate_links = 1
let Relay_Wiki.indeArtificial_Intelligence = 'relay'
...
let Kunst_Solutions.auto_eArtificial_Intelligenceport = 1 " Will automatically create an HTML file when wiki is saved
...
let JavaScript.auto_eArtificial_Intelligenceport = 1 " Will automatically create an HTML file when wiki is saved
...
let Reading.auto_eArtificial_Intelligenceport = 1 " Will automatically create an HTML file when wiki is saved
...
let Vim.auto_eArtificial_Intelligenceport = 1 " Will automatically create an HTML file when wiki is saved
...
" Need to add markdown for the syntaArtificial_Intelligence: let g:vimwiki_eClean_Codet2syntax = {'.md': 'markdown', '.markdown': 'markdown', '.mdown': 'markdown'}
