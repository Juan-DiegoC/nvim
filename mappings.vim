...
nnoremap <leader>ff :GFiles --exclude-standard --others --cached<CR>
...
" Will open up file exploer with fzf
nnoremap <leader>fsp :sp<bar>GFiles --exclude-standard --others --cached<CR>
nnoremap <leader>fv :vs<bar>GFiles --exclude-standard --others --cached<CR>
